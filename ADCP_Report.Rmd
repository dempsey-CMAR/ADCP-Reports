...
**Notes:**
  ...
  - All compass headings are relative to True North. 
...
```
Figure `r k`: Current speed and direction throughout the water column.
...
```
Figure `r k`: Current speed distribution throughout the water column. The number of observations in each interval is noted above the bar.
