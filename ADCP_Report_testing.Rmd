...
for(i in 1:4){
  ...
  breaks.i <- c(ints.i$lower - 0.00001, max(ints.i$upper) + 0.00001) # NOT a mistake that using max(upper)
  ...
  # NOTE: subtracting and adding 0.00001 solves the warning message issue and the "range" issue, but it is not a perfect solution. It would be better if we could change the package.
